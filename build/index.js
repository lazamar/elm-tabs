...
var _user$project$Types$Model = {ctor: 'Model'};
var _user$project$Types$DoNothing = {ctor: 'DoNothing'};

var _user$project$Tabs$renderTab = function (_p0) {
	var _p1 = _p0;
	return A2(
...
var _user$project$Tabs$tabs = function (tabList) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$Tabs$renderTab, tabList));
};
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: _user$project$Tabs$tabs(
					{
						ctor: '::',
						_0: A3(_user$project$Tabs$tab, 'First Tab', _user$project$View$showFirst, 'Here is some content'),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Tabs$tab, 'Second Tab', _user$project$View$showSecond, 2),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$State$init = function () {
	var doIrun = function (val) {
		return A2(_elm_lang$core$Debug$log, 'Called at least once', 'DoIrun');
	};
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
